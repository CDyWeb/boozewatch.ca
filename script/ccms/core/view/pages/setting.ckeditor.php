...
if ($_SERVER['REQUEST_METHOD']=='POST') {
	...
	if (isset($_POST['text'])) $something_changed |= SettingsManager::set('ckeditor_'.$node['id'],$_POST['text']);
...
$value=SettingsManager::setting('ckeditor_'.$node['id']);
...
$(document).ready(function() {
  ...
  <p class='btnpanel'>
    ...
    &nbsp;&nbsp;<a href="<?= $_SERVER['REQUEST_URI'] ?>"><?= $view->cmsTranslate('Cancel') ?></a>
  </p>
