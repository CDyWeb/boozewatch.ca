...
class ezcTranslation
{
     ...
     * @return string
     */
    public function parameterCallback( $key, array $params )
    {
    ...
    public function getTranslation( $key, array $params = array() )
    {
        ...
        global $ezcTranslation_instance,$ezcTranslation_params;
        $ezcTranslation_instance=$this;
        $ezcTranslation_params=$params;
        return preg_replace_callback( '@%(([A-Za-z][a-z_]*[a-z])|[1-9])@', function($a) {
          global $ezcTranslation_instance,$ezcTranslation_params;
          return $ezcTranslation_instance->parameterCallback($a[1],$ezcTranslation_params);
        }, $translatedString);
     ...
     * @return string
     */
    public function parameterCallbackCompile( $key, array $params )
    {
        if ( !isset( $params[strtolower( $key )] ) )
        {
            throw new ezcTranslationParameterMissingException( $key );
    ...
    public function compileTranslation( $key, array $params = array() )
    {
        ...
        return preg_replace_callback( '@%(([A-Za-z][a-z_]*[a-z])|[1-9])@', function($a) {
          global $ezcTranslation_instance,$ezcTranslation_params;
          return $ezcTranslation_instance->parameterCallbackCompile($a[1],$ezcTranslation_params);
        }, $translatedString);
